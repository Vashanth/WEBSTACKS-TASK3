    ...
    render() {
        ...
        for (var i = 0; i < ((this.props.records.Reducer.records.length > 3) ? 3 : this.props.records.Reducer.records.length); i++) {
            if(this.state.search === ''  || (this.props.records.Reducer.records[i]["name"]["first"].toLowerCase().includes(this.state.search.toLowerCase())) ||  (this.props.records.Reducer.records[i]["name"]["last"].toLowerCase().includes(this.state.search.toLowerCase()))) {
                toppers.push(
                    <Col sm="12" md={{size: 4}} key={i}  id='bor'>
                        <Card className='h-100'  id={i}>
                            ...
                            <Progress bar color="success" animated value={this.props.records.Reducer.records[i]["points"]} max={25}>Points progress</Progress>
                        </Card>
            ...
            <Row>
                ...
                <Col sm="12" md={{size: this.state.size}}>
                    <Container className="topList">
                        ...
                        <Row className='otherRow'>
                            <Table borderless='true' className="mains2">
                ...
                {this.state.size === 8 ? (
                    <Col sm="12" md={{size: 4}} className='sizeClass'>
                        ...
                        <div className="text-center viewAlone">
                        ...
                        <div className="viewAlone2">
                        <div className="qrvash"><QRCode value={'GITHUB LINK:'+this.state.person["social"]["github"]+'\n'+'LINKEDIN LINK:'+this.state.person["social"]["linkedin"]} /></div>
                            ...
                            <Progress bar color="danger" animated value={this.state.person["points"]} max={25}>Points progress</Progress>                    </div>
                    </Col>
                ) : ''}
