        ...
        if(this.props.user.Reducer.user)
        {
          details =   (
               <Card className='h-100'>
                   <div className="text-center dons">
                   ...
                   <CardBody>
                       ...
                       <Form>
                           <div className="qrs"><QRCode value={'GITHUB LINK:'+this.props.user.Reducer.user["social"]["github"]+'\n'+'LINKEDIN LINK:'+this.props.user.Reducer.user["social"]["linkedin"]} /></div>
